...
def payment():
    ...
    # Check if the value of receiverAddress is equal to voltMillsAddress 

        # Set receiverAddress to the actual address of volt Mills 



        # Else print that the address is not recived. 


    requestUrl = "https://bfs-dev.tynker.com/code/view/64eddabcbc976a19a96faa72/cart.html"
